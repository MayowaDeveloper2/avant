...
export default function Hero() {
    return (
        <div className="flex flex-col items-center">
            <div className="text-[64px] sm:text-[40px] xs:text-[30px] bricolage text-center mt-6">Equipping believers through</div>

            {/* Parent div with relative positioning */}
            <div className="relative bg-white w-[426.25px] h-[60px] sm:w-[300px] sm:h-[40px] xs:w-[250px] xs:h-[35px] border-2 items-center text-center mx-auto">
            ...
            <div className="text-center w-[500px] sm:w-[350px] xs:w-[300px] text-[14px] lg:text-[18px] mt-6">
